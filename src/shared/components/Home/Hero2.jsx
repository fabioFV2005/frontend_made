    ...
    <>
      <section className="relative w-full h-screen overflow-hidden bg-white">
        ...
        <div className="relative z-10 flex h-full">
          <div className="w-1/2 flex flex-col items-center justify-center space-y-8 text-(--color-text-main)">
          ...
          <div className="w-1/2 relative">
            ...
            >
              ...
              <rect
                ...
                clipPath="url(#clip-st1)"
              />
              <path
                d="M938,186.3v398.9c-.06,6.9,5.5,12.54,12.4,12.6.07,0,.13,0,.2,0h214.8c6.96.01,12.61-5.62,12.62-12.58,0-2.1-.52-4.17-1.52-6.02l-214.8-398.8c-2.18-4.11-6.45-6.69-11.1-6.7h0c-6.96,0-12.6,5.64-12.6,12.6h0Z"
                fill="#f1550a"
              />
              <path
                d="M950.7,632.1h241.1c4.64-.04,8.93,2.45,11.2,6.5l136.6,250.5c4.4,8.1-1.7,17.9-11.3,17.9h-150.1c-3.65.03-7.15-1.49-9.6-4.2l-227.4-250.4c-7.2-7.9-1.4-20.3,9.5-20.3Z"
                fill="#868485"
              />
            </svg>
          </div>
